...
public class FormLayoutCodeGenerator extends LayoutCodeGenerator
{
	...
	private static final Method ourFormLayoutConstructor = Method.getMethod("void <init>(java.lang.String," +
			"java.lang.String)");
	private static final Method ourCellConstraintsConstructor = Method.getMethod("void <init>(int,int,int,int," +
			"com.jgoodies.forms.layout.CellConstraints$Alignment,com.jgoodies.forms.layout.CellConstraints$Alignment," +
			"java.awt.Insets)");
	...
	public static String[] HORZ_ALIGN_FIELDS = new String[]{
			"LEFT",
			"CENTER",
			"RIGHT",
			"FILL"
	};
	public static String[] VERT_ALIGN_FIELDS = new String[]{
			"TOP",
			"CENTER",
			"BOTTOM",
			"FILL"
	...
	private static void generateGroups(final GeneratorAdapter generator,
			final int[][] groups,
			final Method setGroupsMethod)
	{
		if(groups.length == 0)
		{
			return;
	...
	private static void addNewCellConstraints(final UIGeneratorAdapter generator, final LwComponent lwComponent)
	{
