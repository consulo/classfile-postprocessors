...
public class GridBagLayoutCodeGenerator extends LayoutCodeGenerator
{
	...
	private void generateFillerPanel(final UIGeneratorAdapter generator,
	...
	private static void generateConversionResult(final UIGeneratorAdapter generator,
			final GridBagConverter.Result result,
			final int componentLocal,
			final int parentLocal)
	{
	...
	private static void generateGridBagConstraints(final UIGeneratorAdapter generator,
	...
	private static void checkSetSize(final UIGeneratorAdapter generator,
			final int componentLocal,
			...
			final Dimension dimension)
	{
		if(dimension != null)
		{
			...
			generator.invokeVirtual(Type.getType(Component.class), new Method(methodName, Type.VOID_TYPE,
					new Type[]{Type.getType(Dimension.class)}));
		}
	}

	private static void setIntField(final GeneratorAdapter generator,
			final int local,
	...
	private static void setDoubleField(final GeneratorAdapter generator,
			final int local,
			final String fieldName,
			final double value)
	{
