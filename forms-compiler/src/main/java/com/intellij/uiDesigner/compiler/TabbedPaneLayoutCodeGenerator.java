...
public class TabbedPaneLayoutCodeGenerator extends LayoutCodeGenerator
{
	...
	private final Method myAddTabMethod = Method.getMethod("void addTab(java.lang.String,javax.swing.Icon," +
			...
			final int parentLocal)
	{
		...
		final LwTabbedPane.Constraints tabConstraints = (LwTabbedPane.Constraints) lwComponent
